...
CREATE TABLE Funcionarios(
	...
	INSERT INTO Funcionarios (NOME, EMAIL, CIDADE, ESTADO, SETOR, SALARIO, DATA_DE_NASCIMENTO, DATA_DE_ADMISSÃO)
	 VALUES
	     ('Ana Souza', 'ana@infonet.com', ' Sao Paulo', 'SP', 'TI', '5200.00', '1974-10-07', '2001-05-10'),
		 ('Carlos Lima', 'carlos@infonet.com',  'Rio de Janeiro', 'RJ', 'RH', '3800.00' , '2007-04-23' , '2025-07-03'),
		 ('Fernanda Costa', 'fernanda@infonet.com', 'Campinas', 'SP', 'Financeiro', '4500.00' , '2000-03-27' , ''),
		 ('Roberto Alves', 'roberto@infonet.com', 'Belo Horizonte', 'MG', 'TI', '6100.00'),
		 ('Juliana Matos', 'juliana@infonet.com', 'Curitiba', 'PR', 'Comercial', '2900.00' , '2008-04-04' , '2025-09-11'),
